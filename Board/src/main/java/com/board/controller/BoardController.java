...
public class BoardController {
	...
	public String update(BoardDTO dto, PageObject pageObject) throws Exception {
		...
		if (result == 1) {
			...
			return "redirect:view.do?no=" + dto.getNo() + "&inc=0" + "&page=" + pageObject.getPage() + "&parPageNum="
					+ pageObject.getPerGroupPageNum() + "&key=" + pageObject.getKey() + "&word="
