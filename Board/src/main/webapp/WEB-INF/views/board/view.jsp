...
<div class="coment" >
	<div class="container">
		...
		<form name="commentInsertForm" colspan="2">
			<div class="input-group">
				<input type="hidden" name="no" value="${vo.no}" /> 
				<input type="text" class="form-control" id="content" name="qnaContent" placeholder="내용을 입력하세요."> 
				<input type="text" class="form-control" id="qnaWriter" name="qnaWriter" placeholder="이름을 입력하세요."> 
	...
	<!--                     추가                         -->
	<%@ include file="/WEB-INF/views/board/comments.jsp"%>
